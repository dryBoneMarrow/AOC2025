// This is taken from the official GNU Linear Programming Kit Reference Manual and annotated by me
// license may differ (probably GPL)
...
s4:     glp_add_rows(lp, 3);
        ...
        // Name and set upper limit for each row
...
s11:    glp_add_cols(lp, 3);
        ...
        // Name, set lower limit and add objective coefficient («weight») for each column
...
s26:    ia[5] = 2, ja[5] = 2, ar[5] = 4.0; /* a[2,2] =  4 */
s28:    ia[6] = 2, ja[6] = 3, ar[6] = 5.0; /* a[2,3] =  5 */
s25:    ia[7] = 3, ja[7] = 1, ar[7] = 2.0; /* a[3,1] =  2 */
s27:    ia[8] = 3, ja[8] = 2, ar[8] = 2.0; /* a[3,2] =  2 */
s29:    ia[9] = 3, ja[9] = 3, ar[9] = 6.0; /* a[3,3] =  6 */

        // Add constraint matrix to problem
